...
| page.page-state.filename-slug | A page created with an explicit FileName via sitepages/pages stores that name (FileLeafRef) as sent; a name with spaces and capitals is either normalised by the server or refused, and the sample records which | 2026-09-07 | PENDING LIVE RUN | tests/fixtures/discovery.m5.json#pageState | formwork gen findprobe |
| page.page-state.description-banner | Description and BannerImageUrl set by item MERGE (SP.FieldUrlValue) and SavePageAsDraft read back on the page entity | 2026-09-07 | PENDING LIVE RUN | tests/fixtures/discovery.m5.json#pageState | formwork gen findprobe |
| page.page-state.layout-article | A page created with PageLayoutType Article persists the layout type | 2026-09-07 | PENDING LIVE RUN | tests/fixtures/discovery.m5.json#pageState | formwork gen findprobe |
| page.page-state.promoted-state | PromotedState 1 survives both at-create (POST) and by item MERGE afterwards | 2026-09-07 | PENDING LIVE RUN | tests/fixtures/discovery.m5.json#pageState | formwork gen findprobe |
| page.page-state.publish-flow | A fresh draft carries OData__UIVersionString 0.x and CheckoutUserId null; checkoutpage then publish bump the version string and clear checkout | 2026-09-07 | PENDING LIVE RUN | tests/fixtures/discovery.m5.json#pageState | formwork gen findprobe |
| page.page-state.permission-inheritance | A page created by sitepages/pages does not break role inheritance: HasUniqueRoleAssignments reads false on the fresh item | 2026-09-07 | PENDING LIVE RUN | tests/fixtures/discovery.m5.json#pageState | formwork gen findprobe |
