...
(async () => {
  ...
  //     Unmeasured until a live run is folded (M5, 2026-09-06).
  ...
  //     factors and the written order, or re-sorts by column. Unmeasured
  //     until a live run is folded (M5, 2026-09-06).
  ...
  const discovery = {
    ...
    // fate under `fixtures`. Measurement only: no compile gate reads them
    // until a live run is folded (M5, 2026-09-06).
    webpartProperties: {
